...
public class ReverseLeftClonedTree {
    ...
    public static BinaryNode reverseLeftCloneTree(BinaryNode node) {
        if (node != null && node.left != null) {
            node.left = node.left.left;
        }

        if (node != null) {
            reverseLeftCloneTree(node.left);
        }
        if (node != null) {
            reverseLeftCloneTree(node.right);
        }
    ...
    public static void main(String[] args) throws IOException {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            int[] input = new int[] { 50, 50, 25, 25, 12, 12, -1, -1, -1, -1, 37, 37, 30, 30, -1, -1, -1, -1, -1, -1,
                    75, 75, 62, 62, -1, -1, 70, 70, -1, -1, -1, -1, 87, 87, -1, -1, -1 };
