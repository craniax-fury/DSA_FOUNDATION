...
public class LargestBST {
    ...
    public static LBSTPair largestBST(BinaryNode node) {
    ...
    public static void main(String[] args) throws IOException {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            int[] input = new int[] { 50,25,12,-1,-1,37,30,-1,-1,51,-1,-1,75,62,60,-1,-1,77,-1,-1,87,-1,-1 };
            ...
            System.out.println(Result.node + "@" + Result.size);
        }
    }
}
